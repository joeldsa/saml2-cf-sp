...
--%>
<%@page import="org.springframework.security.providers.ExpiringUsernameAuthenticationToken"%>
<%@page import="org.opensaml.saml2.core.impl.NameIDImpl"%>
<%@ page session="false"%>
...
<c:set var="username" scope="page">
	<%= ((NameIDImpl)((ExpiringUsernameAuthenticationToken)((HttpServletRequest)pageContext.getRequest()).getUserPrincipal()).getPrincipal()).getValue()%>
</c:set>
...
<body id="micro">
	<div class="splash">
		...
		<div style="float: right;">
			<ul class='super-nav'>
				<li><span>Welcome <strong>${fn:escapeXml(username)}</strong></span>
					/ <c:url value="/saml/logout" var="url" /> <a
