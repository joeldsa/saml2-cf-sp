	...
	<div class="splash">
		...
		<div class="splash-box">
			<article class="container">
				<p>Sign in with your organization's credentials.</p>
				<form id="loginForm" name="loginForm"
					action="<c:url value="/saml/discovery"/>" method="GET" novalidate>
					<input type="hidden" name="returnIDParam" value="idp"/>
					<input type="hidden" name="entityID" value="http://login.cloudfoundry.com/horizon"/>
